...
public class RockPaperScissorsController extends Application {
    ...
    public void play(SimpleLinkedList<Player> players) {
    ...
    public void finishGame() throws IOException {
        if (player1_result == "rock" && player2_result == "rock") {
        ...
        if (player1_result == "rock" && player2_result == "paper") {
        ...
        if (player1_result == "rock" && player2_result == "scissors") {
        ...
        if (player1_result == "paper" && player2_result == "rock") {
            Result.setText("player1.nickname + Wins!");
            Rock1.setDisable(true);
            Rock2.setDisable(true);
            Paper1.setDisable(true);
        ...
        if (player1_result == "paper" && player2_result == "paper") {
        ...
        if (player1_result == "paper" && player2_result == "scissors") {
            Result.setText("player2.nickname + Wins!");
            Rock1.setDisable(true);
            Rock2.setDisable(true);
            Paper1.setDisable(true);
        ...
        if (player1_result == "scissors" && player2_result == "rock") {
            Result.setText("player2.nickname + Wins!");
            Rock1.setDisable(true);
            Rock2.setDisable(true);
            Paper1.setDisable(true);
        ...
        if (player1_result == "scissors" && player2_result == "paper") {
            Result.setText("player1.nickname + Wins!");
            Rock1.setDisable(true);
            Rock2.setDisable(true);
            Paper1.setDisable(true);
        ...
        if (player2_result == "scissors" && player2_result == "scissors") {
